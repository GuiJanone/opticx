...
$(BUILDDIR)/bands.o :$(BUILDDIR)/parser_optics_xatu_dim.o $(BUILDDIR)/parser_wannier90_tb.o $(BUILDDIR)/constants_math.o 
$(BUILDDIR)/ome.o : $(BUILDDIR)/ome_ex.o $(BUILDDIR)/ome_sp.o $(BUILDDIR)/parser_input_file.o 
$(BUILDDIR)/ome_ex.o : $(BUILDDIR)/parser_optics_xatu_dim.o $(BUILDDIR)/parser_wannier90_tb.o $(BUILDDIR)/parser_input_file.o $(BUILDDIR)/constants_math.o 
$(BUILDDIR)/ome_sp.o : $(BUILDDIR)/parser_optics_xatu_dim.o $(BUILDDIR)/parser_wannier90_tb.o $(BUILDDIR)/constants_math.o 
$(BUILDDIR)/optical_response.o : $(BUILDDIR)/sigma_second.o $(BUILDDIR)/sigma_first.o $(BUILDDIR)/parser_input_file.o 
$(BUILDDIR)/parser_optics_xatu_dim.o : $(BUILDDIR)/parser_input_file.o $(BUILDDIR)/parser_wannier90_tb.o $(BUILDDIR)/constants_math.o 
$(BUILDDIR)/parser_wannier90_tb.o : $(BUILDDIR)/parser_input_file.o 
$(BUILDDIR)/sigma_first.o : $(BUILDDIR)/ome_ex.o $(BUILDDIR)/parser_optics_xatu_dim.o $(BUILDDIR)/parser_wannier90_tb.o $(BUILDDIR)/parser_input_file.o $(BUILDDIR)/constants_math.o 
$(BUILDDIR)/sigma_second.o : $(BUILDDIR)/parser_wannier90_tb.o $(BUILDDIR)/ome_ex.o $(BUILDDIR)/parser_optics_xatu_dim.o $(BUILDDIR)/parser_input_file.o $(BUILDDIR)/constants_math.o 
